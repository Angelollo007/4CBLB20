...
## Generated on : Wed Mar 26 10:33:17 2025
...
dleadlag.c.o : $(MATLAB_WORKSPACE)/C/Users/pijus/Downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dleadlag.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dlowpass1.c.o : $(MATLAB_WORKSPACE)/C/Users/pijus/Downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dnotch.c.o : $(MATLAB_WORKSPACE)/C/Users/pijus/Downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dnotch.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dpd.c.o : $(MATLAB_WORKSPACE)/C/Users/pijus/Downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dpd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dweakint.c.o : $(MATLAB_WORKSPACE)/C/Users/pijus/Downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint.c
	$(CC) $(CFLAGS) -o "$@" "$<"
