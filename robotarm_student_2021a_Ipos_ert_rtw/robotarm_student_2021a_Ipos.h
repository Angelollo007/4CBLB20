...
typedef struct {
  ...
  real_T Dctpd2_k;                     /* '<S9>/Dctpd2' */
  real_T Dctleadlag3_j;                /* '<S9>/Dctleadlag3' */
...
typedef struct {
  ...
  real_T IdentPressure;                /* '<S1>/Stateflow 1' */
  real_T AreaBad;                      /* '<S1>/Stateflow 1' */
  real_T AreaGood;                     /* '<S1>/Stateflow 1' */
  real_T elapTime;                     /* '<S1>/Stateflow 1' */
  real_T yPlaced;                      /* '<S1>/Stateflow 1' */
  real_T v;                            /* '<S1>/Stateflow 1' */
  real_T yTracked;                     /* '<S1>/Stateflow 1' */
  real_T track;                        /* '<S1>/Stateflow 1' */
  real_T picked;                       /* '<S1>/Stateflow 1' */
  ...
  uint16_T temporalCounter_i1_i;       /* '<S23>/Supervisor' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  real_T Gain1_Gain_k;                 /* Expression: 1
                                        ...
                                        */
  real_T Dctpd2_P1_Size_c[2];          /* Computed Parameter: Dctpd2_P1_Size_c
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctpd2_P1_c;                  /* Expression: kp
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctpd2_P2_Size_g[2];          /* Computed Parameter: Dctpd2_P2_Size_g
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctpd2_P2_n;                  /* Expression: kv
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctpd2_P3_Size_i[2];          /* Computed Parameter: Dctpd2_P3_Size_i
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctpd2_P3_a;                  /* Expression: 0.001
                                        * Referenced by: '<S9>/Dctpd2'
                                        */
  real_T Dctleadlag3_P1_Size_l[2];  /* Computed Parameter: Dctleadlag3_P1_Size_l
                                     * Referenced by: '<S9>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P1_e;             /* Expression: f_num
                                        * Referenced by: '<S9>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P2_Size_c[2];  /* Computed Parameter: Dctleadlag3_P2_Size_c
                                     * Referenced by: '<S9>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P2_p;             /* Expression: f_den
                                        * Referenced by: '<S9>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P3_Size_i[2];  /* Computed Parameter: Dctleadlag3_P3_Size_i
                                     * Referenced by: '<S9>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P3_j;             /* Expression: 0.001
                                        * Referenced by: '<S9>/Dctleadlag3'
                                        */
  real_T Gain1_Gain_ea;                /* Expression: 1
