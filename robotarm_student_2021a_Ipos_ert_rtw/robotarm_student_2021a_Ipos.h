...
typedef struct {
  ...
  real_T Dctintegrator3_RWORK_g[2];    /* '<S13>/Dctintegrator3' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  /* Expression: [0                    0                    0      1738030949.5573;0  0  0  0;0  0  0  0]
   * Referenced by: '<S4>/Object detection matrix'
   */
  real_T nObject_Value;                /* Expression: 2
                                        * Referenced by: '<S1>/nObject'
                                        */
