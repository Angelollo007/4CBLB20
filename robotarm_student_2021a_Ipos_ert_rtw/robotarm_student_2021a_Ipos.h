...
/* Block signals for system '<S1>/quintic trajectory time1' */
typedef struct {
  real_T A[36];
  real_T B[6];
  real_T path;                         /* '<S1>/quintic trajectory time1' */
  real_T smax;
  real_T ndbl;
  real_T cdiff;
  real_T B_m;
  ...
  int32_T ix;
  int32_T c_k;
} B_quintictrajectorytime1_robo_T;

/* Block states (default storage) for system '<S1>/quintic trajectory time1' */
typedef struct {
  real_T previous_value_reference_start;/* '<S1>/quintic trajectory time1' */
  real_T previous_value_reference_end; /* '<S1>/quintic trajectory time1' */
  real_T index;                        /* '<S1>/quintic trajectory time1' */
  emxArray_real_T_robotarm_stud_T* path_array;/* '<S1>/quintic trajectory time1' */
  boolean_T path_array_not_empty;      /* '<S1>/quintic trajectory time1' */
} DW_quintictrajectorytime1_rob_T;

/* Block states (default storage) for system '<S33>/Serial Write1' */
typedef struct {
  codertarget_raspi_internal_SC_T obj; /* '<S33>/Serial Write1' */
  boolean_T objisempty;                /* '<S33>/Serial Write1' */
...
typedef struct {
  ...
  char_T HomingRunningSwitch[256];     /* '<S25>/Homing Running Switch' */
  real_T B[6];
  uint8_T MatrixConcatenate1[32];      /* '<S33>/Matrix Concatenate1' */
  uint8_T MatrixConcatenate[32];       /* '<S34>/Matrix Concatenate' */
  char_T cv[31];
  boolean_T FixPtRelationalOperator[12];/* '<S17>/FixPt Relational Operator' */
  char_T ManualSwitch1[256];           /* '<S1>/Manual Switch1' */
  real_T SFunction;                    /* '<S3>/S-Function' */
  real_T ec_Ipos_o1;                   /* '<S21>/ec_Ipos' */
  real_T ec_Ipos_o2;                   /* '<S21>/ec_Ipos' */
  real_T ec_Ipos_o3;                   /* '<S21>/ec_Ipos' */
  real_T ec_Ipos_o4;                   /* '<S21>/ec_Ipos' */
  real_T ec_Ipos_o5;                   /* '<S21>/ec_Ipos' */
  real_T Gain;                         /* '<S19>/Gain' */
  real_T Constant1;                    /* '<S38>/Constant1' */
  real_T DiscreteTimeIntegrator;       /* '<S38>/Discrete-Time Integrator' */
  real_T Sum2;                         /* '<S26>/Sum2' */
  real_T Gain1;                        /* '<S19>/Gain1' */
  real_T Constant1_e;                  /* '<S44>/Constant1' */
  real_T DiscreteTimeIntegrator_e;     /* '<S44>/Discrete-Time Integrator' */
  real_T Sum2_a;                       /* '<S27>/Sum2' */
  real_T Gain2;                        /* '<S19>/Gain2' */
  real_T Constant1_f;                  /* '<S54>/Constant1' */
  real_T DiscreteTimeIntegrator_p;     /* '<S54>/Discrete-Time Integrator' */
  real_T Sum2_e;                       /* '<S28>/Sum2' */
  real_T set_robot_calibration_r;      /* '<S20>/set_robot_calibration_r' */
  real_T set_robot_calibration_x;      /* '<S20>/set_robot_calibration_x' */
  real_T set_robot_calibration_z;      /* '<S20>/set_robot_calibration_z' */
  real_T Add1;                         /* '<S24>/Add1' */
  real_T Gain3;                        /* '<S19>/Gain3' */
  real_T Gain5;                        /* '<S19>/Gain5' */
  real_T Gain_h;                       /* '<S35>/Gain' */
  real_T Dctintegrator;                /* '<S35>/Dctintegrator' */
  real_T Dctleadlag;                   /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass;                  /* '<S35>/Dct1lowpass' */
  real_T Gain_p;                       /* '<S36>/Gain' */
  real_T Dctleadlag_l;                 /* '<S36>/Dctleadlag' */
  real_T Dct1lowpass_i;                /* '<S36>/Dct1lowpass' */
  real_T Saturation1;                  /* '<S26>/Saturation1' */
  real_T Gain1_p;                      /* '<S42>/Gain1' */
  real_T Dctintegrator_g;              /* '<S42>/Dctintegrator' */
  real_T Dctleadlag_h;                 /* '<S42>/Dctleadlag' */
  real_T Dct1lowpass_k;                /* '<S42>/Dct1lowpass' */
  real_T Gain1_o;                      /* '<S43>/Gain1' */
  real_T Dctleadlag_b;                 /* '<S43>/Dctleadlag' */
  real_T Dct1lowpass_j;                /* '<S43>/Dct1lowpass' */
  real_T Saturation1_n;                /* '<S27>/Saturation1' */
  real_T Gain_i;                       /* '<S51>/Gain' */
  real_T Dctintegrator_i;              /* '<S51>/Dctintegrator' */
  real_T Dctleadlag_m;                 /* '<S51>/Dctleadlag' */
  real_T Dct1lowpass_p;                /* '<S51>/Dct1lowpass' */
  real_T Gain_f;                       /* '<S52>/Gain' */
  real_T Dctleadlag_e;                 /* '<S52>/Dctleadlag' */
  real_T Dct1lowpass_a;                /* '<S52>/Dct1lowpass' */
  real_T Saturation1_a;                /* '<S28>/Saturation1' */
  real_T Gain1_a;                      /* '<S61>/Gain1' */
  real_T Dctintegrator3;               /* '<S61>/Dctintegrator3' */
  real_T Dct1lowpass_g;                /* '<S61>/Dct1lowpass' */
  real_T Dctleadlag_k;                 /* '<S61>/Dctleadlag' */
  real_T Saturation1_d;                /* '<S29>/Saturation1' */
  real_T jogSpeed;                     /* '<S29>/Supervisor' */
  real_T homeControllerEnabled;        /* '<S29>/Supervisor' */
  real_T resetEnc;                     /* '<S29>/Supervisor' */
  real_T homingBusy;                   /* '<S29>/Supervisor' */
  real_T Ready;                        /* '<S29>/Supervisor' */
  real_T StopSim;                      /* '<S29>/Supervisor' */
  real_T jogSpeed_i;                   /* '<S28>/Supervisor' */
  real_T toPoint;                      /* '<S28>/Supervisor' */
  real_T homeControllerEnabled_b;      /* '<S28>/Supervisor' */
  real_T resetEnc_g;                   /* '<S28>/Supervisor' */
  real_T homingBusy_n;                 /* '<S28>/Supervisor' */
  real_T airBagEnabled;                /* '<S28>/Supervisor' */
  real_T airBagRef;                    /* '<S28>/Supervisor' */
  real_T controlEnabled;               /* '<S28>/Supervisor' */
  real_T Ready_n;                      /* '<S28>/Supervisor' */
  real_T StopSim_n;                    /* '<S28>/Supervisor' */
  real_T y;                            /* '<S28>/Angle2Z' */
  real_T jogSpeed_c;                   /* '<S27>/Supervisor2' */
  real_T toPoint_e;                    /* '<S27>/Supervisor2' */
  real_T homeControllerEnabled_k;      /* '<S27>/Supervisor2' */
  real_T resetEnc_c;                   /* '<S27>/Supervisor2' */
  real_T homingBusy_j;                 /* '<S27>/Supervisor2' */
  real_T airBagEnabled_o;              /* '<S27>/Supervisor2' */
  real_T airBagRef_a;                  /* '<S27>/Supervisor2' */
  real_T controlEnabled_a;             /* '<S27>/Supervisor2' */
  real_T Ready_i;                      /* '<S27>/Supervisor2' */
  real_T StopSim_o;                    /* '<S27>/Supervisor2' */
  real_T jogSpeed_o;                   /* '<S26>/Supervisor' */
  real_T toPoint_b;                    /* '<S26>/Supervisor' */
  real_T homeControllerEnabled_o;      /* '<S26>/Supervisor' */
  real_T resetEnc_k;                   /* '<S26>/Supervisor' */
  real_T freddy_k;                     /* '<S26>/Supervisor' */
  real_T homingBusy_l;                 /* '<S26>/Supervisor' */
  real_T airBagEnabled_f;              /* '<S26>/Supervisor' */
  real_T airBagRef_g;                  /* '<S26>/Supervisor' */
  real_T controlEnabled_l;             /* '<S26>/Supervisor' */
  real_T Ready_a;                      /* '<S26>/Supervisor' */
  real_T StopSim_j;                    /* '<S26>/Supervisor' */
  real_T y_b;                          /* '<S26>/Angle2Z' */
  ...
  real_T Gain1_c;                      /* '<S16>/Gain1' */
  real_T Dctleadlag2;                  /* '<S16>/Dctleadlag2' */
  real_T Dctintegrator3_c;             /* '<S16>/Dctintegrator3' */
  real_T Dct1lowpass_b;                /* '<S16>/Dct1lowpass' */
  ...
  real_T Dctpd2_g;                     /* '<S11>/Dctpd2' */
  real_T Dctleadlag3_b;                /* '<S11>/Dctleadlag3' */
  real_T Gain1_oc;                     /* '<S10>/Gain1' */
  real_T Dctpd2_j;                     /* '<S10>/Dctpd2' */
  real_T Dctleadlag3_f;                /* '<S10>/Dctleadlag3' */
  real_T Gain1_oz;                     /* '<S15>/Gain1' */
  real_T Dctleadlag2_l;                /* '<S15>/Dctleadlag2' */
  real_T Dctintegrator3_l;             /* '<S15>/Dctintegrator3' */
  real_T Dctnotch4;                    /* '<S15>/Dctnotch4' */
  real_T Dctpd5;                       /* '<S15>/Dctpd5' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  ...
  real_T d13;
  real_T d12_tmp;
  real_T LimitAcceleration_h;          /* '<S38>/Limit Acceleration' */
  real_T TSamp;                        /* '<S60>/TSamp' */
  real_T TSamp_d;                      /* '<S50>/TSamp' */
  real_T TSamp_k;                      /* '<S41>/TSamp' */
  real_T LimitAcceleration;            /* '<S54>/Limit Acceleration' */
  real_T LimitAcceleration_b;          /* '<S44>/Limit Acceleration' */
  real_T Add2;                         /* '<S20>/Add2' */
  real_T Add;                          /* '<S20>/Add' */
  ...
  boolean_T RelationalOperator_f;      /* '<S27>/Relational Operator' */
  boolean_T RelationalOperator_k;      /* '<S28>/Relational Operator' */
  boolean_T Compare;                   /* '<S23>/Compare' */
  boolean_T Compare_j;                 /* '<S22>/Compare' */
  B_quintictrajectorytime1_robo_T sf_quintictrajectorytime2;/* '<S1>/quintic trajectory time2' */
  B_quintictrajectorytime1_robo_T sf_quintictrajectorytime1;/* '<S1>/quintic trajectory time1' */
} B_robotarm_student_2021a_Ipos_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S38>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_g;/* '<S26>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_m;/* '<S27>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_o;/* '<S44>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_a;/* '<S28>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_j;/* '<S54>/Discrete-Time Integrator' */
  real_T UnitDelay_DSTATE;             /* '<S20>/Unit Delay' */
  real_T UnitDelay1_DSTATE;            /* '<S20>/Unit Delay1' */
  real_T DiscreteTimeIntegrator_DSTATE_k;/* '<S29>/Discrete-Time Integrator' */
  real_T UD_DSTATE;                    /* '<S60>/UD' */
  real_T UD_DSTATE_c;                  /* '<S50>/UD' */
  real_T UD_DSTATE_cc;                 /* '<S41>/UD' */
  real_T DelayInput1_DSTATE[12];       /* '<S17>/Delay Input1' */
  real_T Discreteintegrator_DSTATE;    /* '<S1>/Discrete  integrator' */
  char_T Delay_DSTATE[256];            /* '<S31>/Delay' */
  real_T PrevY;                        /* '<S54>/Limit Speed' */
  real_T PrevY_j;                      /* '<S54>/Limit Acceleration' */
  real_T PrevY_d;                      /* '<S44>/Limit Speed' */
  real_T PrevY_f;                      /* '<S44>/Limit Acceleration' */
  real_T PrevY_i;                      /* '<S38>/Limit Speed' */
  real_T PrevY_k;                      /* '<S38>/Limit Acceleration' */
  real_T currentcarPos;                /* '<S28>/Supervisor' */
  real_T currentcarPos_d;              /* '<S27>/Supervisor2' */
  real_T currentcarPos_l;              /* '<S26>/Supervisor' */
  ...
  real_T Dctintegrator_RWORK[2];       /* '<S35>/Dctintegrator' */
  real_T Dctleadlag_RWORK[2];          /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass_RWORK[2];         /* '<S35>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_k[2];        /* '<S36>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_a[2];       /* '<S36>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_m[2];     /* '<S42>/Dctintegrator' */
  real_T Dctleadlag_RWORK_g[2];        /* '<S42>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_n[2];       /* '<S42>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_j[2];        /* '<S43>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_k[2];       /* '<S43>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_i[2];     /* '<S51>/Dctintegrator' */
  real_T Dctleadlag_RWORK_n[2];        /* '<S51>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_g[2];       /* '<S51>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_i[2];        /* '<S52>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_h[2];       /* '<S52>/Dct1lowpass' */
  real_T Dctintegrator3_RWORK[2];      /* '<S61>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_ay[2];      /* '<S61>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_o[2];        /* '<S61>/Dctleadlag' */
  real_T Dctleadlag2_RWORK[2];         /* '<S16>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_e[2];    /* '<S16>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_m[2];       /* '<S16>/Dct1lowpass' */
  ...
  real_T Dctpd2_RWORK_b[2];            /* '<S11>/Dctpd2' */
  real_T Dctleadlag3_RWORK_o[2];       /* '<S11>/Dctleadlag3' */
  real_T Dctpd2_RWORK_j[2];            /* '<S10>/Dctpd2' */
  real_T Dctleadlag3_RWORK_cb[2];      /* '<S10>/Dctleadlag3' */
  real_T Dctleadlag2_RWORK_j[2];       /* '<S15>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_gh[2];   /* '<S15>/Dctintegrator3' */
  real_T Dctnotch4_RWORK[4];           /* '<S15>/Dctnotch4' */
  real_T Dctpd5_RWORK[2];              /* '<S15>/Dctpd5' */
  struct {
    void *LoggedData;
  } Scope_PWORK;                       /* '<S28>/Scope' */

  struct {
    void *LoggedData;
  } Scope9_PWORK;                      /* '<S26>/Scope9' */

  struct {
    void *LoggedData;
  } Scope_PWORK_p;                     /* '<S39>/Scope' */
  ...
  int32_T sfEvent;                     /* '<S29>/Supervisor' */
  int32_T sfEvent_n;                   /* '<S28>/Supervisor' */
  int32_T sfEvent_h;                   /* '<S27>/Supervisor2' */
  int32_T sfEvent_k;                   /* '<S26>/Supervisor' */
  int32_T sfEvent_e;                   /* '<S1>/Stateflow 1' */
  uint32_T is_c1_robotarm_student_2021a_Ip;/* '<S29>/Supervisor' */
  uint32_T is_c18_robotarm_student_2021a_I;/* '<S28>/Supervisor' */
  uint32_T is_c16_robotarm_student_2021a_I;/* '<S27>/Supervisor2' */
  uint32_T is_c12_robotarm_student_2021a_I;/* '<S26>/Supervisor' */
  ...
  uint16_T temporalCounter_i1;         /* '<S29>/Supervisor' */
  uint16_T temporalCounter_i1_m;       /* '<S28>/Supervisor' */
  uint16_T temporalCounter_i1_me;      /* '<S27>/Supervisor2' */
  uint16_T temporalCounter_i1_c;       /* '<S26>/Supervisor' */
  ...
  int8_T Subsystem3_SubsysRanBC;       /* '<S30>/Subsystem3' */
  ...
  uint8_T is_active_c1_robotarm_student_2;/* '<S29>/Supervisor' */
  uint8_T is_active_c18_robotarm_student_;/* '<S28>/Supervisor' */
  uint8_T is_active_c16_robotarm_student_;/* '<S27>/Supervisor2' */
  uint8_T is_active_c12_robotarm_student_;/* '<S26>/Supervisor' */
  ...
  DW_SerialWrite1_robotarm_stud_T SerialWrite;/* '<S33>/Serial Write1' */
  DW_SerialWrite1_robotarm_stud_T SerialWrite1;/* '<S33>/Serial Write1' */
  DW_quintictrajectorytime1_rob_T sf_quintictrajectorytime2;/* '<S1>/quintic trajectory time2' */
  DW_quintictrajectorytime1_rob_T sf_quintictrajectorytime1;/* '<S1>/quintic trajectory time1' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  real_T Gain1_Gain_h;                 /* Expression: 1
                                        ...
                                        */
  real_T Dctpd2_P1_Size_f[2];          /* Computed Parameter: Dctpd2_P1_Size_f
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctpd2_P1_n;                  /* Expression: kp
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctpd2_P2_Size_k[2];          /* Computed Parameter: Dctpd2_P2_Size_k
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctpd2_P2_h;                  /* Expression: kv
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctpd2_P3_Size_l[2];          /* Computed Parameter: Dctpd2_P3_Size_l
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctpd2_P3_f;                  /* Expression: 0.001
                                        * Referenced by: '<S11>/Dctpd2'
                                        */
  real_T Dctleadlag3_P1_Size_d[2];  /* Computed Parameter: Dctleadlag3_P1_Size_d
                                     * Referenced by: '<S11>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P1_l;             /* Expression: f_num
                                        * Referenced by: '<S11>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P2_Size_i[2];  /* Computed Parameter: Dctleadlag3_P2_Size_i
                                     * Referenced by: '<S11>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P2_j;             /* Expression: f_den
                                        * Referenced by: '<S11>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P3_Size_d[2];  /* Computed Parameter: Dctleadlag3_P3_Size_d
                                     * Referenced by: '<S11>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P3_k;             /* Expression: 0.001
                                        * Referenced by: '<S11>/Dctleadlag3'
                                        */
  ...
  real_T Dctpd5_P3;                    /* Expression: 0.001
                                        * Referenced by: '<S15>/Dctpd5'
                                        */
  real_T Gain7_Gain;                   /* Expression: 0.02
...
struct tag_RTM_robotarm_student_2021a_Ipos_T {
  ...
  struct {
    ...
    struct _ssSFcnModelMethods4 methods4[42];
    struct _ssStatesInfo2 statesInfo2[42];
    ssPeriodicStatesInfo periodicStatesInfo[42];
    struct _ssPortInfo2 inputOutputPortInfo2[42];
    struct {
      time_T sfcnPeriod[1];
      time_T sfcnOffset[1];
      int_T sfcnTsMap[1];
 ...
 * Block '<S21>/Saturation' : Unused code path elimination
 ...
 * '<S12>'  : 'robotarm_student_2021a_Ipos/Controller/quintic trajectory time'
 * '<S13>'  : 'robotarm_student_2021a_Ipos/Controller/quintic trajectory time1'
 * '<S14>'  : 'robotarm_student_2021a_Ipos/Controller/quintic trajectory time2'
 * '<S15>'  : 'robotarm_student_2021a_Ipos/Controller/r_controller_without_double_integrator'
 * '<S16>'  : 'robotarm_student_2021a_Ipos/Controller/r_controller_without_double_integrator1'
 * '<S17>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Detect Change'
 * '<S18>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Enabled Subsystem'
 * '<S19>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem'
 * '<S20>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor'
 * '<S21>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem/Ipos'
 * '<S22>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant'
 * '<S23>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant1'
 * '<S24>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/HomingBusyCheck'
 * '<S25>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem'
 * '<S26>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R'
 * '<S27>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X'
 * '<S28>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z'
 * '<S29>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1'
 * '<S30>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring'
 * '<S31>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem'
 * '<S32>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3'
 * '<S33>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem'
 * '<S34>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem1'
 ...
 * '<S37>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Angle2Z'
 * '<S38>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory'
 * '<S39>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Selector1'
 * '<S40>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Supervisor'
 * '<S41>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory/Discrete Derivative'
 * '<S42>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X1'
 * '<S43>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X2'
 * '<S44>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory'
 * '<S45>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector'
 * '<S46>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector1'
 * '<S47>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector2'
 * '<S48>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector3'
 * '<S49>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Supervisor2'
 * '<S50>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory/Discrete Derivative'
 ...
 * '<S53>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Angle2Z'
 * '<S54>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory'
 * '<S55>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector'
 * '<S56>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector1'
 * '<S57>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector2'
 * '<S58>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector3'
 * '<S59>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Supervisor'
 * '<S60>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory/Discrete Derivative'
 * '<S61>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Controller Conveyor'
 * '<S62>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Supervisor'
 */
