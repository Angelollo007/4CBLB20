  ...
  if (robotarm_student_2021a_Ipos_DW.is_active_Object_Detection != 0U) {
    switch (robotarm_student_2021a_Ipos_DW.is_Object_Detection) {
     ...
     case robotarm_student__IN_Transition:
      if (robotarm_student_2021a_Ipos_DW.temporalCounter_i2 >= 4096U) {
        robotarm_student_2021a_Ipos_DW.is_Object_Detection =
  ...
  if (robotarm_student_2021a_Ipos_DW.is_active_Identification != 0U) {
    switch (robotarm_student_2021a_Ipos_DW.is_Identification) {
     ...
     case robotarm_student_20_IN_Object_1:
      if (robotarm_student_2021a_Ipos_DW.temporalCounter_i3 >= 10240U) {
        robotarm_student_2021a_Ipos_DW.is_Identification =
  ...
  if (robotarm_student_2021a_Ipos_DW.is_active_ActionDone != 0U) {
    switch (robotarm_student_2021a_Ipos_DW.is_ActionDone) {
     case robotarm_student_2021_IN_Action:
      if (robotarm_student_2021a_Ipos_DW.temporalCounter_i4 >= 4096U) {
...
void robotarm_student_2021a_Ipos_step(void)
{
  ...
  if (robotarm_student_2021a_Ipos_B.Add1 > 0.0) {
    ...
    if (robotarm_student_2021a_Ipos_DW.isNotInit) {
      ...
      if (robotarm_student_2021a_Ipos_DW.temporalCounter_i3 < 16383U) {
        robotarm_student_2021a_Ipos_DW.temporalCounter_i3++;
      }

      if (robotarm_student_2021a_Ipos_DW.temporalCounter_i4 < 8191U) {
  ...
  /* S-Function (dweakint): '<S47>/Dctintegrator' */

  /* Level2 S-Function Block: '<S47>/Dctintegrator' (dweakint) */
  {
  ...
  /* End of RateLimiter: '<S50>/Limit Speed' */
  ...
  /* RateLimiter: '<S50>/Limit Acceleration' */
  robotarm_student_2021a_Ipos_B.rtb_Gain_idx_0 =
    robotarm_student_2021a_Ipos_B.LimitAcceleration_h -
  ...
  /* End of RateLimiter: '<S50>/Limit Acceleration' */
...
void robotarm_student_2021a_Ipos_initialize(void)
{
  ...
  /* External mode info */
  robotarm_student_2021a_Ipos_M->Sizes.checksums[0] = (3779623556U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[1] = (3483103616U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[2] = (357099821U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[3] = (3441033055U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S17>/ec_Ipos (Ipos360) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[8];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S22>/Reset EncoderR (ec_IposResetEnc) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[9];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S31>/Dctintegrator (dweakint) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[10];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S31>/Dctleadlag (dleadlag) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[11];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S31>/Dct1lowpass (dlowpass1) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[12];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S38>/Dctintegrator (dweakint) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[16];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S47>/Dctintegrator (dweakint) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[22];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S47>/Dctleadlag (dleadlag) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[23];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S47>/Dct1lowpass (dlowpass1) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[24];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S57>/Dctintegrator3 (dweakint) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[28];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S57>/Dct1lowpass (dlowpass1) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[29];
    ...
    /* Level2 S-Function Block: robotarm_student_2021a_Ipos/<S57>/Dctleadlag (dleadlag) */
    {
      SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[30];
  ...
  /* Start for S-Function (dweakint): '<S47>/Dctintegrator' */
  /* Level2 S-Function Block: '<S47>/Dctintegrator' (dweakint) */
  {
    SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[22];
    sfcnStart(rts);
...

  {
    ...
    /* InitializeConditions for RateLimiter: '<S50>/Limit Speed' */
    robotarm_student_2021a_Ipos_DW.PrevY =
    ...
    /* InitializeConditions for RateLimiter: '<S50>/Limit Acceleration' */
    robotarm_student_2021a_Ipos_DW.PrevY_j =
    ...
    /* End of InitializeConditions for UnitDelay: '<S13>/Delay Input1' */
    ...
    /* SystemInitialize for Outport: '<S14>/Delay [s]' incorporates:
     *  Inport: '<S14>/In1'
     */
...
void robotarm_student_2021a_Ipos_terminate(void)
{
  ...
  /* Terminate for S-Function (dweakint): '<S47>/Dctintegrator' */
  /* Level2 S-Function Block: '<S47>/Dctintegrator' (dweakint) */
  {
    SimStruct *rts = robotarm_student_2021a_Ipos_M->childSfunctions[22];
    sfcnTerminate(rts);
