...
typedef struct {
  ...
  char_T HomingRunningSwitch[256];     /* '<S21>/Homing Running Switch' */
  uint8_T MatrixConcatenate1[32];      /* '<S29>/Matrix Concatenate1' */
  uint8_T MatrixConcatenate[32];       /* '<S30>/Matrix Concatenate' */
  char_T cv[31];
  boolean_T FixPtRelationalOperator[12];/* '<S13>/FixPt Relational Operator' */
  ...
  real_T Constant1_f;                  /* '<S50>/Constant1' */
  real_T DiscreteTimeIntegrator_p;     /* '<S50>/Discrete-Time Integrator' */
  ...
  real_T Dctintegrator_i;              /* '<S47>/Dctintegrator' */
  real_T Dctleadlag_m;                 /* '<S47>/Dctleadlag' */
  real_T Dct1lowpass_p;                /* '<S47>/Dct1lowpass' */
  real_T Gain_f;                       /* '<S48>/Gain' */
  real_T Dctleadlag_e;                 /* '<S48>/Dctleadlag' */
  real_T Dct1lowpass_a;                /* '<S48>/Dct1lowpass' */
  real_T Saturation1_a;                /* '<S24>/Saturation1' */
  real_T Gain1_a;                      /* '<S57>/Gain1' */
  real_T Dctintegrator3;               /* '<S57>/Dctintegrator3' */
  real_T Dct1lowpass_g;                /* '<S57>/Dct1lowpass' */
  real_T Dctleadlag_k;                 /* '<S57>/Dctleadlag' */
  ...
  real_T jogSpeed_i;                   /* '<S24>/Supervisor' */
  real_T toPoint;                      /* '<S24>/Supervisor' */
  real_T homeControllerEnabled_b;      /* '<S24>/Supervisor' */
  real_T resetEnc_g;                   /* '<S24>/Supervisor' */
  real_T homingBusy_n;                 /* '<S24>/Supervisor' */
  real_T airBagEnabled;                /* '<S24>/Supervisor' */
  real_T airBagRef;                    /* '<S24>/Supervisor' */
  real_T controlEnabled;               /* '<S24>/Supervisor' */
  real_T Ready_n;                      /* '<S24>/Supervisor' */
  real_T StopSim_n;                    /* '<S24>/Supervisor' */
  real_T y;                            /* '<S24>/Angle2Z' */
  real_T jogSpeed_c;                   /* '<S23>/Supervisor2' */
  real_T toPoint_e;                    /* '<S23>/Supervisor2' */
  real_T homeControllerEnabled_k;      /* '<S23>/Supervisor2' */
  real_T resetEnc_c;                   /* '<S23>/Supervisor2' */
  real_T homingBusy_j;                 /* '<S23>/Supervisor2' */
  real_T airBagEnabled_o;              /* '<S23>/Supervisor2' */
  real_T airBagRef_a;                  /* '<S23>/Supervisor2' */
  real_T controlEnabled_a;             /* '<S23>/Supervisor2' */
  real_T Ready_i;                      /* '<S23>/Supervisor2' */
  real_T StopSim_o;                    /* '<S23>/Supervisor2' */
  real_T jogSpeed_o;                   /* '<S22>/Supervisor' */
  real_T toPoint_b;                    /* '<S22>/Supervisor' */
  real_T homeControllerEnabled_o;      /* '<S22>/Supervisor' */
  real_T resetEnc_k;                   /* '<S22>/Supervisor' */
  real_T freddy_k;                     /* '<S22>/Supervisor' */
  real_T homingBusy_l;                 /* '<S22>/Supervisor' */
  real_T airBagEnabled_f;              /* '<S22>/Supervisor' */
  real_T airBagRef_g;                  /* '<S22>/Supervisor' */
  real_T controlEnabled_l;             /* '<S22>/Supervisor' */
  real_T Ready_a;                      /* '<S22>/Supervisor' */
  real_T StopSim_j;                    /* '<S22>/Supervisor' */
  real_T y_b;                          /* '<S22>/Angle2Z' */
  ...
  real_T TSamp;                        /* '<S56>/TSamp' */
  real_T TSamp_d;                      /* '<S46>/TSamp' */
  real_T TSamp_k;                      /* '<S37>/TSamp' */
  real_T LimitAcceleration;            /* '<S50>/Limit Acceleration' */
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator_DSTATE_j;/* '<S50>/Discrete-Time Integrator' */
  ...
  real_T UD_DSTATE_c;                  /* '<S46>/UD' */
  real_T UD_DSTATE_cc;                 /* '<S37>/UD' */
  real_T DelayInput1_DSTATE[12];       /* '<S13>/Delay Input1' */
  real_T Discreteintegrator_DSTATE;    /* '<S1>/Discrete  integrator' */
  char_T Delay_DSTATE[256];            /* '<S27>/Delay' */
  real_T PrevY;                        /* '<S50>/Limit Speed' */
  real_T PrevY_j;                      /* '<S50>/Limit Acceleration' */
  ...
  real_T currentcarPos_d;              /* '<S23>/Supervisor2' */
  real_T currentcarPos_l;              /* '<S22>/Supervisor' */
  ...
  real_T Dctintegrator_RWORK_i[2];     /* '<S47>/Dctintegrator' */
  real_T Dctleadlag_RWORK_n[2];        /* '<S47>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_g[2];       /* '<S47>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_i[2];        /* '<S48>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_h[2];       /* '<S48>/Dct1lowpass' */
  real_T Dctintegrator3_RWORK[2];      /* '<S57>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_ay[2];      /* '<S57>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_o[2];        /* '<S57>/Dctleadlag' */
  ...
  int32_T sfEvent_n;                   /* '<S24>/Supervisor' */
  int32_T sfEvent_h;                   /* '<S23>/Supervisor2' */
  int32_T sfEvent_k;                   /* '<S22>/Supervisor' */
  int32_T sfEvent_e;                   /* '<S1>/Stateflow 1' */
  uint32_T is_c1_robotarm_student_2021a_Ip;/* '<S25>/Supervisor' */
  uint32_T is_c18_robotarm_student_2021a_I;/* '<S24>/Supervisor' */
  uint32_T is_c16_robotarm_student_2021a_I;/* '<S23>/Supervisor2' */
  uint32_T is_c12_robotarm_student_2021a_I;/* '<S22>/Supervisor' */
  ...
  uint32_T temporalCounter_i1;         /* '<S1>/Stateflow 1' */
  uint16_T temporalCounter_i1_i;       /* '<S25>/Supervisor' */
  uint16_T temporalCounter_i1_m;       /* '<S24>/Supervisor' */
  uint16_T temporalCounter_i1_me;      /* '<S23>/Supervisor2' */
  uint16_T temporalCounter_i1_c;       /* '<S22>/Supervisor' */
  uint16_T temporalCounter_i2;         /* '<S1>/Stateflow 1' */
  ...
  uint8_T is_active_c1_robotarm_student_2;/* '<S25>/Supervisor' */
  uint8_T is_active_c18_robotarm_student_;/* '<S24>/Supervisor' */
  uint8_T is_active_c16_robotarm_student_;/* '<S23>/Supervisor2' */
  uint8_T is_active_c12_robotarm_student_;/* '<S22>/Supervisor' */
  ...
  DW_SerialWrite1_robotarm_stud_T SerialWrite;/* '<S29>/Serial Write1' */
  DW_SerialWrite1_robotarm_stud_T SerialWrite1;/* '<S29>/Serial Write1' */
 ...
 * '<S13>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Detect Change'
 * '<S14>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Enabled Subsystem'
 * '<S15>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem'
 * '<S16>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor'
 * '<S17>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem/Ipos'
 * '<S18>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant'
 * '<S19>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant1'
 * '<S20>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/HomingBusyCheck'
 * '<S21>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem'
 * '<S22>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R'
 * '<S23>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X'
 * '<S24>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z'
 * '<S25>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1'
 * '<S26>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring'
 * '<S27>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem'
 * '<S28>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3'
 * '<S29>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem'
 * '<S30>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem1'
 * '<S31>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/ '
 * '<S32>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/   '
 * '<S33>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Angle2Z'
 * '<S34>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory'
 * '<S35>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Selector1'
 * '<S36>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Supervisor'
 * '<S37>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory/Discrete Derivative'
 * '<S38>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X1'
 * '<S39>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X2'
 * '<S40>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory'
 * '<S41>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector'
 * '<S42>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector1'
 * '<S43>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector2'
 * '<S44>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector3'
 * '<S45>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Supervisor2'
 * '<S46>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory/Discrete Derivative'
 * '<S47>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/    '
 * '<S48>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/     '
 * '<S49>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Angle2Z'
 * '<S50>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory'
 * '<S51>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector'
 * '<S52>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector1'
 * '<S53>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector2'
 * '<S54>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector3'
 * '<S55>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Supervisor'
 * '<S56>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory/Discrete Derivative'
 * '<S57>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Controller Conveyor'
 * '<S58>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Supervisor'
 */
