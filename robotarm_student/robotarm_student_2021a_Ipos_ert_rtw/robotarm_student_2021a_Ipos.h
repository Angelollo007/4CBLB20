...
typedef struct {
  ...
  real_T Dctleadlag3;                  /* '<S12>/Dctleadlag3' */
  real_T Dct1lowpass_a5;               /* '<S12>/Dct1lowpass' */
  real_T Dctintegrator_j;              /* '<S12>/Dctintegrator' */
  real_T Dct1lowpass_h;                /* '<S10>/Dct1lowpass' */
  real_T Dctleadlag_hg;                /* '<S10>/Dctleadlag' */
  real_T Dctintegrator_h;              /* '<S10>/Dctintegrator' */
  real_T Sum6;                         /* '<S1>/Sum6' */
  ...
  real_T d12;
  real_T d13;
  real_T Gain1_cl;                     /* '<S27>/Gain1' */
  real_T Derivative5;                  /* '<S1>/Derivative5' */
  real_T d12_tmp;
...
typedef struct {
  ...
  real_T TimeStampA;                   /* '<S1>/Derivative4' */
  real_T LastUAtTimeA;                 /* '<S1>/Derivative4' */
  real_T TimeStampB;                   /* '<S1>/Derivative4' */
  real_T LastUAtTimeB;                 /* '<S1>/Derivative4' */
  ...
  real_T Dctleadlag3_RWORK[2];         /* '<S12>/Dctleadlag3' */
  real_T Dct1lowpass_RWORK_gi[2];      /* '<S12>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_h[2];     /* '<S12>/Dctintegrator' */
  real_T Dct1lowpass_RWORK_l[2];       /* '<S10>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_m[2];        /* '<S10>/Dctleadlag' */
  real_T Dctintegrator_RWORK_l[2];     /* '<S10>/Dctintegrator' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  real_T Gain_Gain_h;                  /* Expression: 25
                                        ...
                                        */
  real_T Dctintegrator_P1_Size_n[2];
                                  /* Computed Parameter: Dctintegrator_P1_Size_n
                                   * Referenced by: '<S36>/Dctintegrator'
                                   */
  real_T Dctintegrator_P1_e;           /* Expression: f_num
                                        * Referenced by: '<S36>/Dctintegrator'
                                        */
  ...
  real_T Dctleadlag_P2_g;              /* Expression: f_den
                                        * Referenced by: '<S36>/Dctleadlag'
                                        */
  real_T Dctleadlag_P3_Size_hd[2];  /* Computed Parameter: Dctleadlag_P3_Size_hd
                                     * Referenced by: '<S36>/Dctleadlag'
                                     */
  ...
  real_T Dctleadlag_P1_Size_d[2];    /* Computed Parameter: Dctleadlag_P1_Size_d
                                      ...
                                      */
  real_T Dctleadlag_P1_m4;             /* Expression: f_num
                                        * Referenced by: '<S43>/Dctleadlag'
                                        */
  ...
  real_T Dctleadlag_P1_p;              /* Expression: f_num
                                        * Referenced by: '<S44>/Dctleadlag'
                                        */
  real_T Dctleadlag_P2_Size_m3[2];  /* Computed Parameter: Dctleadlag_P2_Size_m3
                                     * Referenced by: '<S44>/Dctleadlag'
                                     */
  ...
  real_T Dctintegrator_P1_k;           /* Expression: f_num
                                        * Referenced by: '<S52>/Dctintegrator'
                                        */
  real_T Dctintegrator_P2_Size_o4[2];
  ...
  real_T Dctleadlag_P2_Size_n[2];    /* Computed Parameter: Dctleadlag_P2_Size_n
                                      * Referenced by: '<S62>/Dctleadlag'
                                      */
  real_T Dctleadlag_P2_fs;             /* Expression: f_den
                                        * Referenced by: '<S62>/Dctleadlag'
                                        */
