...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/Angelo/Desktop/4CBLB20/robotarm_student
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
%.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Ipos360.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/Ipos360.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dleadlag.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dleadlag.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dlowpass1.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dnotch.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dnotch.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dpd.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dpd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dweakint.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_IposResetEnc.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_IposResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Supervisor.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Supervisor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
