...
void robotarm_student_2021a_Ipos_initialize(void)
{
  ...
  /* External mode info */
  robotarm_student_2021a_Ipos_M->Sizes.checksums[0] = (3353001318U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[1] = (3232180619U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[2] = (758421773U);
  robotarm_student_2021a_Ipos_M->Sizes.checksums[3] = (4180194454U);
