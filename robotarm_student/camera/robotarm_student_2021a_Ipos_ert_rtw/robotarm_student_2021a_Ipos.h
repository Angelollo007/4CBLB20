...
/* Block states (default storage) for system '<S32>/Serial Write1' */
typedef struct {
  codertarget_raspi_internal_SC_T obj; /* '<S32>/Serial Write1' */
  boolean_T objisempty;                /* '<S32>/Serial Write1' */
} DW_SerialWrite1_robotarm_stud_T;

/* Block signals (default storage) */
typedef struct {
  char_T rtb_StringConcatenate_m[256];
  char_T HomingRunningSwitch[256];     /* '<S24>/Homing Running Switch' */
  uint8_T MatrixConcatenate1[32];      /* '<S32>/Matrix Concatenate1' */
  uint8_T MatrixConcatenate[32];       /* '<S33>/Matrix Concatenate' */
  char_T cv[31];
  boolean_T FixPtRelationalOperator[12];/* '<S16>/FixPt Relational Operator' */
  char_T ManualSwitch1[256];           /* '<S1>/Manual Switch1' */
  real_T SFunction;                    /* '<S3>/S-Function' */
  real_T ec_Ipos_o1;                   /* '<S20>/ec_Ipos' */
  real_T ec_Ipos_o2;                   /* '<S20>/ec_Ipos' */
  real_T ec_Ipos_o3;                   /* '<S20>/ec_Ipos' */
  real_T ec_Ipos_o4;                   /* '<S20>/ec_Ipos' */
  real_T ec_Ipos_o5;                   /* '<S20>/ec_Ipos' */
  real_T Gain;                         /* '<S18>/Gain' */
  real_T Constant1;                    /* '<S37>/Constant1' */
  real_T DiscreteTimeIntegrator;       /* '<S37>/Discrete-Time Integrator' */
  real_T Sum;                          /* '<S25>/Sum' */
  real_T Sum2;                         /* '<S25>/Sum2' */
  real_T Gain1;                        /* '<S18>/Gain1' */
  real_T Constant1_e;                  /* '<S43>/Constant1' */
  real_T DiscreteTimeIntegrator_e;     /* '<S43>/Discrete-Time Integrator' */
  real_T Sum_p;                        /* '<S26>/Sum' */
  real_T Sum2_a;                       /* '<S26>/Sum2' */
  real_T Gain2;                        /* '<S18>/Gain2' */
  real_T Constant1_f;                  /* '<S53>/Constant1' */
  real_T DiscreteTimeIntegrator_p;     /* '<S53>/Discrete-Time Integrator' */
  real_T Sum_o;                        /* '<S27>/Sum' */
  real_T Sum2_e;                       /* '<S27>/Sum2' */
  real_T set_robot_calibration_r;      /* '<S19>/set_robot_calibration_r' */
  real_T set_robot_calibration_x;      /* '<S19>/set_robot_calibration_x' */
  real_T set_robot_calibration_z;      /* '<S19>/set_robot_calibration_z' */
  real_T Add1;                         /* '<S23>/Add1' */
  real_T Gain3;                        /* '<S18>/Gain3' */
  real_T Gain5;                        /* '<S18>/Gain5' */
  real_T Gain_h;                       /* '<S34>/Gain' */
  real_T Dctintegrator;                /* '<S34>/Dctintegrator' */
  real_T Dctleadlag;                   /* '<S34>/Dctleadlag' */
  real_T Dct1lowpass;                  /* '<S34>/Dct1lowpass' */
  real_T Product;                      /* '<S25>/Product' */
  real_T Gain_p;                       /* '<S35>/Gain' */
  real_T Dctleadlag_l;                 /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass_i;                /* '<S35>/Dct1lowpass' */
  real_T Saturation1;                  /* '<S25>/Saturation1' */
  real_T Gain1_p;                      /* '<S41>/Gain1' */
  real_T Dctintegrator_g;              /* '<S41>/Dctintegrator' */
  real_T Dctleadlag_h;                 /* '<S41>/Dctleadlag' */
  real_T Dct1lowpass_k;                /* '<S41>/Dct1lowpass' */
  real_T Product_e;                    /* '<S26>/Product' */
  real_T Gain1_o;                      /* '<S42>/Gain1' */
  real_T Dctleadlag_b;                 /* '<S42>/Dctleadlag' */
  real_T Dct1lowpass_j;                /* '<S42>/Dct1lowpass' */
  real_T Saturation1_n;                /* '<S26>/Saturation1' */
  real_T Gain_i;                       /* '<S50>/Gain' */
  real_T Dctintegrator_i;              /* '<S50>/Dctintegrator' */
  real_T Dctleadlag_m;                 /* '<S50>/Dctleadlag' */
  real_T Dct1lowpass_p;                /* '<S50>/Dct1lowpass' */
  real_T Product_n;                    /* '<S27>/Product' */
  real_T Gain_f;                       /* '<S51>/Gain' */
  real_T Dctleadlag_e;                 /* '<S51>/Dctleadlag' */
  real_T Dct1lowpass_a;                /* '<S51>/Dct1lowpass' */
  real_T Saturation1_a;                /* '<S27>/Saturation1' */
  real_T DiscreteTimeIntegrator_i;     /* '<S28>/Discrete-Time Integrator' */
  real_T Gain1_a;                      /* '<S60>/Gain1' */
  real_T Dctintegrator3;               /* '<S60>/Dctintegrator3' */
  real_T Dct1lowpass_g;                /* '<S60>/Dct1lowpass' */
  real_T Dctleadlag_k;                 /* '<S60>/Dctleadlag' */
  real_T Saturation1_d;                /* '<S28>/Saturation1' */
  real_T jogSpeed;                     /* '<S28>/Supervisor' */
  real_T homeControllerEnabled;        /* '<S28>/Supervisor' */
  real_T resetEnc;                     /* '<S28>/Supervisor' */
  real_T homingBusy;                   /* '<S28>/Supervisor' */
  real_T Ready;                        /* '<S28>/Supervisor' */
  real_T StopSim;                      /* '<S28>/Supervisor' */
  real_T jogSpeed_i;                   /* '<S27>/Supervisor' */
  real_T toPoint;                      /* '<S27>/Supervisor' */
  real_T homeControllerEnabled_b;      /* '<S27>/Supervisor' */
  real_T resetEnc_g;                   /* '<S27>/Supervisor' */
  real_T homingBusy_n;                 /* '<S27>/Supervisor' */
  real_T airBagEnabled;                /* '<S27>/Supervisor' */
  real_T airBagRef;                    /* '<S27>/Supervisor' */
  real_T controlEnabled;               /* '<S27>/Supervisor' */
  real_T Ready_n;                      /* '<S27>/Supervisor' */
  real_T StopSim_n;                    /* '<S27>/Supervisor' */
  real_T y;                            /* '<S27>/Angle2Z' */
  real_T jogSpeed_c;                   /* '<S26>/Supervisor2' */
  real_T toPoint_e;                    /* '<S26>/Supervisor2' */
  real_T homeControllerEnabled_k;      /* '<S26>/Supervisor2' */
  real_T resetEnc_c;                   /* '<S26>/Supervisor2' */
  real_T homingBusy_j;                 /* '<S26>/Supervisor2' */
  real_T airBagEnabled_o;              /* '<S26>/Supervisor2' */
  real_T airBagRef_a;                  /* '<S26>/Supervisor2' */
  real_T controlEnabled_a;             /* '<S26>/Supervisor2' */
  real_T Ready_i;                      /* '<S26>/Supervisor2' */
  real_T StopSim_o;                    /* '<S26>/Supervisor2' */
  real_T jogSpeed_o;                   /* '<S25>/Supervisor' */
  real_T toPoint_b;                    /* '<S25>/Supervisor' */
  real_T homeControllerEnabled_o;      /* '<S25>/Supervisor' */
  real_T resetEnc_k;                   /* '<S25>/Supervisor' */
  real_T freddy_k;                     /* '<S25>/Supervisor' */
  real_T homingBusy_l;                 /* '<S25>/Supervisor' */
  real_T airBagEnabled_f;              /* '<S25>/Supervisor' */
  real_T airBagRef_g;                  /* '<S25>/Supervisor' */
  real_T controlEnabled_l;             /* '<S25>/Supervisor' */
  real_T Ready_a;                      /* '<S25>/Supervisor' */
  real_T StopSim_j;                    /* '<S25>/Supervisor' */
  real_T y_b;                          /* '<S25>/Angle2Z' */
  ...
  real_T Dctleadlag2;                  /* '<S15>/Dctleadlag2' */
  real_T Dctintegrator3_c;             /* '<S15>/Dctintegrator3' */
  real_T Dct1lowpass_b;                /* '<S15>/Dct1lowpass' */
  ...
  real_T Gain1_oz;                     /* '<S14>/Gain1' */
  real_T Dctleadlag2_l;                /* '<S14>/Dctleadlag2' */
  real_T Dctintegrator3_l;             /* '<S14>/Dctintegrator3' */
  real_T Dctnotch4;                    /* '<S14>/Dctnotch4' */
  real_T Dctpd5;                       /* '<S14>/Dctpd5' */
  real_T Derivative4;                  /* '<S1>/Derivative4' */
  real_T Sum4;                         /* '<S1>/Sum4' */
  real_T Plot;                         /* '<S1>/Plot' */
  real_T Stop;                         /* '<S1>/Stop' */
  real_T Sum_m;                        /* '<S4>/Sum' */
  ...
  real_T d12_tmp;
  real_T d13_tmp;
  real_T LimitAcceleration_h;          /* '<S37>/Limit Acceleration' */
  real_T TSamp;                        /* '<S59>/TSamp' */
  real_T TSamp_d;                      /* '<S49>/TSamp' */
  real_T TSamp_k;                      /* '<S40>/TSamp' */
  real_T LimitAcceleration;            /* '<S53>/Limit Acceleration' */
  real_T LimitAcceleration_b;          /* '<S43>/Limit Acceleration' */
  real_T Add2;                         /* '<S19>/Add2' */
  real_T Add;                          /* '<S19>/Add' */
  ...
  boolean_T RelationalOperator_f;      /* '<S26>/Relational Operator' */
  boolean_T RelationalOperator_k;      /* '<S27>/Relational Operator' */
  boolean_T Compare;                   /* '<S22>/Compare' */
  boolean_T Compare_j;                 /* '<S21>/Compare' */
  boolean_T LogicalOperator1;          /* '<S25>/Logical Operator1' */
  boolean_T LogicalOperator1_p;        /* '<S26>/Logical Operator1' */
  boolean_T LogicalOperator1_i;        /* '<S27>/Logical Operator1' */
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator_DSTATE_m;/* '<S26>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_o;/* '<S43>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_a;/* '<S27>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_j;/* '<S53>/Discrete-Time Integrator' */
  real_T UnitDelay_DSTATE;             /* '<S19>/Unit Delay' */
  real_T UnitDelay1_DSTATE;            /* '<S19>/Unit Delay1' */
  real_T DiscreteTimeIntegrator_DSTATE_k;/* '<S28>/Discrete-Time Integrator' */
  real_T UD_DSTATE;                    /* '<S59>/UD' */
  real_T UD_DSTATE_c;                  /* '<S49>/UD' */
  real_T UD_DSTATE_cc;                 /* '<S40>/UD' */
  real_T DelayInput1_DSTATE[12];       /* '<S16>/Delay Input1' */
  real_T Discreteintegrator_DSTATE;    /* '<S1>/Discrete  integrator' */
  char_T Delay_DSTATE[256];            /* '<S30>/Delay' */
  real_T PrevY;                        /* '<S53>/Limit Speed' */
  real_T PrevY_j;                      /* '<S53>/Limit Acceleration' */
  real_T PrevY_d;                      /* '<S43>/Limit Speed' */
  real_T PrevY_f;                      /* '<S43>/Limit Acceleration' */
  real_T PrevY_i;                      /* '<S37>/Limit Speed' */
  real_T PrevY_k;                      /* '<S37>/Limit Acceleration' */
  real_T currentcarPos;                /* '<S27>/Supervisor' */
  real_T currentcarPos_d;              /* '<S26>/Supervisor2' */
  real_T currentcarPos_l;              /* '<S25>/Supervisor' */
  ...
  real_T TimeStampA_c;                 /* '<S1>/Derivative4' */
  real_T LastUAtTimeA_f;               /* '<S1>/Derivative4' */
  real_T TimeStampB_p;                 /* '<S1>/Derivative4' */
  real_T LastUAtTimeB_c;               /* '<S1>/Derivative4' */
  real_T TimeStampA_h;                 /* '<S1>/Derivative5' */
  real_T LastUAtTimeA_k;               /* '<S1>/Derivative5' */
  real_T TimeStampB_a;                 /* '<S1>/Derivative5' */
  real_T LastUAtTimeB_n;               /* '<S1>/Derivative5' */
  ...
  real_T Dctintegrator_RWORK[2];       /* '<S34>/Dctintegrator' */
  real_T Dctleadlag_RWORK[2];          /* '<S34>/Dctleadlag' */
  real_T Dct1lowpass_RWORK[2];         /* '<S34>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_k[2];        /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_a[2];       /* '<S35>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_m[2];     /* '<S41>/Dctintegrator' */
  real_T Dctleadlag_RWORK_g[2];        /* '<S41>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_n[2];       /* '<S41>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_j[2];        /* '<S42>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_k[2];       /* '<S42>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_i[2];     /* '<S50>/Dctintegrator' */
  real_T Dctleadlag_RWORK_n[2];        /* '<S50>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_g[2];       /* '<S50>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_i[2];        /* '<S51>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_h[2];       /* '<S51>/Dct1lowpass' */
  real_T Dctintegrator3_RWORK[2];      /* '<S60>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_ay[2];      /* '<S60>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_o[2];        /* '<S60>/Dctleadlag' */
  real_T Dctleadlag2_RWORK[2];         /* '<S15>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_e[2];    /* '<S15>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_m[2];       /* '<S15>/Dct1lowpass' */
  ...
  real_T Dctleadlag2_RWORK_j[2];       /* '<S14>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_gh[2];   /* '<S14>/Dctintegrator3' */
  real_T Dctnotch4_RWORK[4];           /* '<S14>/Dctnotch4' */
  real_T Dctpd5_RWORK[2];              /* '<S14>/Dctpd5' */
  struct {
    void *LoggedData;
  ...
  int32_T sfEvent;                     /* '<S28>/Supervisor' */
  int32_T sfEvent_n;                   /* '<S27>/Supervisor' */
  int32_T sfEvent_h;                   /* '<S26>/Supervisor2' */
  int32_T sfEvent_k;                   /* '<S25>/Supervisor' */
  int32_T sfEvent_e;                   /* '<S1>/Stateflow 1' */
  uint32_T is_c1_robotarm_student_2021a_Ip;/* '<S28>/Supervisor' */
  uint32_T is_c18_robotarm_student_2021a_I;/* '<S27>/Supervisor' */
  uint32_T is_c16_robotarm_student_2021a_I;/* '<S26>/Supervisor2' */
  uint32_T is_c12_robotarm_student_2021a_I;/* '<S25>/Supervisor' */
  ...
  uint16_T temporalCounter_i1;         /* '<S28>/Supervisor' */
  uint16_T temporalCounter_i1_m;       /* '<S27>/Supervisor' */
  uint16_T temporalCounter_i1_me;      /* '<S26>/Supervisor2' */
  uint16_T temporalCounter_i1_c;       /* '<S25>/Supervisor' */
  ...
  int8_T Subsystem3_SubsysRanBC;       /* '<S29>/Subsystem3' */
  int8_T IfActionSubsystem1_SubsysRanBC;/* '<S31>/If Action Subsystem1' */
  int8_T IfActionSubsystem_SubsysRanBC;/* '<S31>/If Action Subsystem' */
  int8_T Controller_SubsysRanBC;       /* '<Root>/Controller' */
  int8_T EnabledSubsystem_SubsysRanBC; /* '<S4>/Enabled Subsystem' */
  uint8_T is_active_c1_robotarm_student_2;/* '<S28>/Supervisor' */
  uint8_T is_active_c18_robotarm_student_;/* '<S27>/Supervisor' */
  uint8_T is_active_c16_robotarm_student_;/* '<S26>/Supervisor2' */
  uint8_T is_active_c12_robotarm_student_;/* '<S25>/Supervisor' */
  ...
  DW_SerialWrite1_robotarm_stud_T SerialWrite;/* '<S32>/Serial Write1' */
  DW_SerialWrite1_robotarm_stud_T SerialWrite1;/* '<S32>/Serial Write1' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  /* Expression: [0                    0                    0      1737857225.3323;0  0  0  0;0  0  0  0]
  ...
  real_T Dctintegrator3_P1_Size_b[2];
                                  ...
                                  * Referenced by: '<S14>/Dctintegrator3'
                                  */
  ...
  real_T Gain5_Gain;                   /* Expression: 0
                                        ...
                                        */
  real_T Gain8_Gain;                   /* Expression: 0.07
  ...
  real_T HomingRunningSwitch2_Threshold;/* Expression: 50
                                         * Referenced by: '<S24>/Homing Running Switch2'
                                         */
  ...
  real_T set_robot_calibration_r_Value;/* Expression: 1.3164
                                        * Referenced by: '<S19>/set_robot_calibration_r'
                                        */
  real_T set_robot_calibration_x_Value;/* Expression: 0.65129
                                        * Referenced by: '<S19>/set_robot_calibration_x'
                                        */
  real_T set_robot_calibration_z_Value;/* Expression: -0.34788
                                        * Referenced by: '<S19>/set_robot_calibration_z'
                                        */
  ...
  real_T Gain3_Gain_n;                 /* Expression: 1/16000*2*pi*2.05*10
                                        ...
                                        */
  real_T Gain4_Gain_e;                 /* Expression: 1/65535
                                        * Referenced by: '<S18>/Gain4'
                                        */
  real_T Gain5_Gain_a;                 /* Expression: 1/2
  ...
  real_T ResetEncoderR_P1_Size[2];  /* Computed Parameter: ResetEncoderR_P1_Size
                                     * Referenced by: '<S25>/Reset EncoderR'
                                     */
  ...
  real_T Dctintegrator_P1_Size[2];  /* Computed Parameter: Dctintegrator_P1_Size
                                     * Referenced by: '<S34>/Dctintegrator'
                                     */
  ...
  real_T Dctintegrator_P1_Size_p[2];
                                   ...
                                   * Referenced by: '<S50>/Dctintegrator'
                                   */
  ...
  real_T Dctintegrator3_P1_Size_m[2];
                                  ...
                                  * Referenced by: '<S60>/Dctintegrator3'
                                  */
  ...
  real_T LimitAcceleration_RisingLim;  /* Expression: 0.5
                                        * Referenced by: '<S53>/Limit Acceleration'
                                        */
  ...
  real_T LimitAcceleration_RisingLim_k;/* Expression: 0.5
                                        * Referenced by: '<S43>/Limit Acceleration'
                                        */
  ...
  char_T StringConstant3_String[256];
                                    ...
                                    * Referenced by: '<S33>/String Constant3'
                                    */
...
struct tag_RTM_robotarm_student_2021a_Ipos_T {
  ...
  struct {
    ...
    SimStruct childSFunctions[40];
    SimStruct *childSFunctionPtrs[40];
    struct _ssBlkInfo2 blkInfo2[40];
    struct _ssSFcnModelMethods2 methods2[40];
    struct _ssSFcnModelMethods3 methods3[40];
    struct _ssSFcnModelMethods4 methods4[40];
    struct _ssStatesInfo2 statesInfo2[40];
    ssPeriodicStatesInfo periodicStatesInfo[40];
    struct _ssPortInfo2 inputOutputPortInfo2[40];
    struct {
      time_T sfcnPeriod[1];
      time_T sfcnOffset[1];
      int_T sfcnTsMap[1];
 ...
 * '<S12>'  : 'robotarm_student_2021a_Ipos/Controller/quintic trajectory time1'
 * '<S13>'  : 'robotarm_student_2021a_Ipos/Controller/quintic trajectory time2'
 * '<S14>'  : 'robotarm_student_2021a_Ipos/Controller/r_controller_without_double_integrator'
 * '<S15>'  : 'robotarm_student_2021a_Ipos/Controller/r_controller_without_double_integrator1'
 * '<S16>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Detect Change'
 * '<S17>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Enabled Subsystem'
 * '<S18>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem'
 * '<S19>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor'
 * '<S20>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem/Ipos'
 * '<S21>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant'
 * '<S22>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant1'
 * '<S23>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/HomingBusyCheck'
 * '<S24>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem'
 * '<S25>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R'
 * '<S26>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X'
 * '<S27>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z'
 * '<S28>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1'
 * '<S29>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring'
 * '<S30>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem'
 * '<S31>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3'
 * '<S32>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem'
 * '<S33>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem1'
 * '<S34>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/ '
 * '<S35>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/   '
 * '<S36>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Angle2Z'
 * '<S37>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory'
 * '<S38>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Selector1'
 * '<S39>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Supervisor'
 * '<S40>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory/Discrete Derivative'
 * '<S41>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X1'
 * '<S42>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X2'
 * '<S43>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory'
 * '<S44>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector'
 * '<S45>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector1'
 * '<S46>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector2'
 * '<S47>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector3'
 * '<S48>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Supervisor2'
 * '<S49>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory/Discrete Derivative'
 * '<S50>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/    '
 * '<S51>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/     '
 * '<S52>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Angle2Z'
 * '<S53>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory'
 * '<S54>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector'
 * '<S55>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector1'
 * '<S56>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector2'
 * '<S57>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector3'
 * '<S58>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Supervisor'
 * '<S59>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory/Discrete Derivative'
 * '<S60>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Controller Conveyor'
 * '<S61>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Supervisor'
 */
