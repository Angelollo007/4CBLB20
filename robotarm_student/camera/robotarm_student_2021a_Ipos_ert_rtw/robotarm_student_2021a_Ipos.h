 ...
 * C source code generated on : Fri Mar 14 15:44:27 2025
 *
...
typedef struct {
  ...
  char_T HomingRunningSwitch[256];     /* '<S18>/Homing Running Switch' */
  ...
  real_T ec_Ipos_o1;                   /* '<S14>/ec_Ipos' */
  real_T ec_Ipos_o2;                   /* '<S14>/ec_Ipos' */
  real_T ec_Ipos_o3;                   /* '<S14>/ec_Ipos' */
  real_T ec_Ipos_o4;                   /* '<S14>/ec_Ipos' */
  real_T ec_Ipos_o5;                   /* '<S14>/ec_Ipos' */
  real_T Gain;                         /* '<S12>/Gain' */
  real_T Constant1;                    /* '<S31>/Constant1' */
  real_T DiscreteTimeIntegrator;       /* '<S31>/Discrete-Time Integrator' */
  real_T Sum;                          /* '<S19>/Sum' */
  real_T Sum2;                         /* '<S19>/Sum2' */
  real_T Gain1;                        /* '<S12>/Gain1' */
  real_T Constant1_e;                  /* '<S37>/Constant1' */
  real_T DiscreteTimeIntegrator_e;     /* '<S37>/Discrete-Time Integrator' */
  real_T Sum_p;                        /* '<S20>/Sum' */
  real_T Sum2_a;                       /* '<S20>/Sum2' */
  real_T Gain2;                        /* '<S12>/Gain2' */
  real_T Constant1_f;                  /* '<S47>/Constant1' */
  real_T DiscreteTimeIntegrator_p;     /* '<S47>/Discrete-Time Integrator' */
  real_T Sum_o;                        /* '<S21>/Sum' */
  real_T Sum2_e;                       /* '<S21>/Sum2' */
  ...
  real_T Gain_p;                       /* '<S29>/Gain' */
  real_T Dctleadlag_l;                 /* '<S29>/Dctleadlag' */
  real_T Dct1lowpass_i;                /* '<S29>/Dct1lowpass' */
  real_T Saturation1;                  /* '<S19>/Saturation1' */
  real_T Gain1_p;                      /* '<S35>/Gain1' */
  real_T Dctintegrator_g;              /* '<S35>/Dctintegrator' */
  real_T Dctleadlag_h;                 /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass_k;                /* '<S35>/Dct1lowpass' */
  real_T Gain1_o;                      /* '<S36>/Gain1' */
  real_T Dctleadlag_b;                 /* '<S36>/Dctleadlag' */
  real_T Dct1lowpass_j;                /* '<S36>/Dct1lowpass' */
  real_T Saturation1_n;                /* '<S20>/Saturation1' */
  real_T Gain_i;                       /* '<S44>/Gain' */
  real_T Dctintegrator_i;              /* '<S44>/Dctintegrator' */
  real_T Dctleadlag_m;                 /* '<S44>/Dctleadlag' */
  real_T Dct1lowpass_p;                /* '<S44>/Dct1lowpass' */
  real_T Gain_f;                       /* '<S45>/Gain' */
  real_T Dctleadlag_e;                 /* '<S45>/Dctleadlag' */
  real_T Dct1lowpass_a;                /* '<S45>/Dct1lowpass' */
  real_T Saturation1_a;                /* '<S21>/Saturation1' */
  real_T DiscreteTimeIntegrator_i;     /* '<S22>/Discrete-Time Integrator' */
  real_T Gain1_a;                      /* '<S54>/Gain1' */
  real_T Dctintegrator3;               /* '<S54>/Dctintegrator3' */
  real_T Dct1lowpass_g;                /* '<S54>/Dct1lowpass' */
  real_T Dctleadlag_k;                 /* '<S54>/Dctleadlag' */
  real_T Saturation1_d;                /* '<S22>/Saturation1' */
  ...
  real_T jogSpeed_i;                   /* '<S21>/Supervisor' */
  real_T toPoint;                      /* '<S21>/Supervisor' */
  real_T homeControllerEnabled_b;      /* '<S21>/Supervisor' */
  real_T resetEnc_g;                   /* '<S21>/Supervisor' */
  ...
  real_T StopSim_n;                    /* '<S21>/Supervisor' */
  real_T y;                            /* '<S21>/Angle2Z' */
  real_T jogSpeed_c;                   /* '<S20>/Supervisor2' */
  real_T toPoint_e;                    /* '<S20>/Supervisor2' */
  real_T homeControllerEnabled_k;      /* '<S20>/Supervisor2' */
  real_T resetEnc_c;                   /* '<S20>/Supervisor2' */
  real_T homingBusy_j;                 /* '<S20>/Supervisor2' */
  real_T airBagEnabled_o;              /* '<S20>/Supervisor2' */
  real_T airBagRef_a;                  /* '<S20>/Supervisor2' */
  real_T controlEnabled_a;             /* '<S20>/Supervisor2' */
  real_T Ready_i;                      /* '<S20>/Supervisor2' */
  real_T StopSim_o;                    /* '<S20>/Supervisor2' */
  real_T jogSpeed_o;                   /* '<S19>/Supervisor' */
  real_T toPoint_b;                    /* '<S19>/Supervisor' */
  real_T homeControllerEnabled_o;      /* '<S19>/Supervisor' */
  real_T resetEnc_k;                   /* '<S19>/Supervisor' */
  real_T freddy_k;                     /* '<S19>/Supervisor' */
  real_T homingBusy_l;                 /* '<S19>/Supervisor' */
  real_T airBagEnabled_f;              /* '<S19>/Supervisor' */
  real_T airBagRef_g;                  /* '<S19>/Supervisor' */
  real_T controlEnabled_l;             /* '<S19>/Supervisor' */
  real_T Ready_a;                      /* '<S19>/Supervisor' */
  real_T StopSim_j;                    /* '<S19>/Supervisor' */
  ...
  real_T Dctpd2_n;                     /* '<S8>/Dctpd2' */
  real_T Dctleadlag3_m;                /* '<S8>/Dctleadlag3' */
  ...
  real_T d12_tmp;
  real_T d13_tmp;
  real_T LimitAcceleration_h;          /* '<S31>/Limit Acceleration' */
  real_T TSamp;                        /* '<S53>/TSamp' */
  real_T TSamp_d;                      /* '<S43>/TSamp' */
  ...
  boolean_T Compare_j;                 /* '<S15>/Compare' */
...
typedef struct {
  ...
  real_T DiscreteTimeIntegrator_DSTATE_m;/* '<S20>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_o;/* '<S37>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_a;/* '<S21>/Discrete-Time Integrator' */
  real_T DiscreteTimeIntegrator_DSTATE_j;/* '<S47>/Discrete-Time Integrator' */
  ...
  real_T UD_DSTATE_c;                  /* '<S43>/UD' */
  real_T UD_DSTATE_cc;                 /* '<S34>/UD' */
  ...
  real_T PrevY;                        /* '<S47>/Limit Speed' */
  real_T PrevY_j;                      /* '<S47>/Limit Acceleration' */
  real_T PrevY_d;                      /* '<S37>/Limit Speed' */
  real_T PrevY_f;                      /* '<S37>/Limit Acceleration' */
  real_T PrevY_i;                      /* '<S31>/Limit Speed' */
  real_T PrevY_k;                      /* '<S31>/Limit Acceleration' */
  ...
  real_T Dctleadlag_RWORK_k[2];        /* '<S29>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_a[2];       /* '<S29>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_m[2];     /* '<S35>/Dctintegrator' */
  real_T Dctleadlag_RWORK_g[2];        /* '<S35>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_n[2];       /* '<S35>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_j[2];        /* '<S36>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_k[2];       /* '<S36>/Dct1lowpass' */
  real_T Dctintegrator_RWORK_i[2];     /* '<S44>/Dctintegrator' */
  real_T Dctleadlag_RWORK_n[2];        /* '<S44>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_g[2];       /* '<S44>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_i[2];        /* '<S45>/Dctleadlag' */
  real_T Dct1lowpass_RWORK_h[2];       /* '<S45>/Dct1lowpass' */
  real_T Dctintegrator3_RWORK[2];      /* '<S54>/Dctintegrator3' */
  real_T Dct1lowpass_RWORK_ay[2];      /* '<S54>/Dct1lowpass' */
  real_T Dctleadlag_RWORK_o[2];        /* '<S54>/Dctleadlag' */
  real_T Dctpd2_RWORK[2];              /* '<S9>/Dctpd2' */
  real_T Dctleadlag3_RWORK[2];         /* '<S9>/Dctleadlag3' */
  real_T Dctpd2_RWORK_o[2];            /* '<S8>/Dctpd2' */
  real_T Dctleadlag3_RWORK_f[2];       /* '<S8>/Dctleadlag3' */
  ...
  int32_T sfEvent_n;                   /* '<S21>/Supervisor' */
  int32_T sfEvent_h;                   /* '<S20>/Supervisor2' */
  int32_T sfEvent_k;                   /* '<S19>/Supervisor' */
  int32_T sfEvent_c;                   /* '<S1>/Stateflow ' */
  uint32_T is_c1_robotarm_student_2021a_Ip;/* '<S22>/Supervisor' */
  uint32_T is_c18_robotarm_student_2021a_I;/* '<S21>/Supervisor' */
  ...
  uint16_T temporalCounter_i1_c;       /* '<S19>/Supervisor' */
  ...
  uint8_T is_active_c16_robotarm_student_;/* '<S20>/Supervisor2' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  real_T Dctpd2_P1_Size_k[2];          /* Computed Parameter: Dctpd2_P1_Size_k
                                        ...
                                        */
  real_T Dctpd2_P1_p;                  /* Expression: kp
                                        * Referenced by: '<S8>/Dctpd2'
                                        */
  real_T Dctpd2_P2_Size_i[2];          /* Computed Parameter: Dctpd2_P2_Size_i
                                        * Referenced by: '<S8>/Dctpd2'
                                        */
  real_T Dctpd2_P2_e;                  /* Expression: kv
                                        * Referenced by: '<S8>/Dctpd2'
                                        */
  real_T Dctpd2_P3_Size_f[2];          /* Computed Parameter: Dctpd2_P3_Size_f
                                        * Referenced by: '<S8>/Dctpd2'
                                        */
  real_T Dctpd2_P3_b;                  /* Expression: 0.001
                                        * Referenced by: '<S8>/Dctpd2'
                                        */
  real_T Dctleadlag3_P1_Size_n[2];  /* Computed Parameter: Dctleadlag3_P1_Size_n
                                     * Referenced by: '<S8>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P1_h;             /* Expression: f_num
                                        * Referenced by: '<S8>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P2_Size_p[2];  /* Computed Parameter: Dctleadlag3_P2_Size_p
                                     * Referenced by: '<S8>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P2_h;             /* Expression: f_den
                                        * Referenced by: '<S8>/Dctleadlag3'
                                        */
  real_T Dctleadlag3_P3_Size_e[2];  /* Computed Parameter: Dctleadlag3_P3_Size_e
                                     * Referenced by: '<S8>/Dctleadlag3'
                                     */
  real_T Dctleadlag3_P3_g;             /* Expression: 0.001
                                        * Referenced by: '<S8>/Dctleadlag3'
                                        */
  ...
  real_T Gain1_Gain_b;                 /* Expression: -100
                                        ...
                                        */
  real_T Object_Value;                 /* Expression: 3
                                        * Referenced by: '<S1>/Object'
                                        */
  real_T Plot_Value;                   /* Expression: 3
...
struct tag_RTM_robotarm_student_2021a_Ipos_T {
  ...
  struct {
    ...
    struct _ssSFcnModelMethods4 methods4[31];
    struct _ssStatesInfo2 statesInfo2[31];
    ssPeriodicStatesInfo periodicStatesInfo[31];
    struct _ssPortInfo2 inputOutputPortInfo2[31];
    struct {
      time_T sfcnPeriod[1];
      time_T sfcnOffset[1];
      int_T sfcnTsMap[1];
 ...
 *
 * Block '<S14>/Saturation' : Unused code path elimination
 ...
 * '<S7>'   : 'robotarm_student_2021a_Ipos/Controller/Stateflow '
 * '<S8>'   : 'robotarm_student_2021a_Ipos/Controller/controller'
 * '<S9>'   : 'robotarm_student_2021a_Ipos/Controller/controller_x_direction'
 * '<S10>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Detect Change'
 * '<S11>'  : 'robotarm_student_2021a_Ipos/Controller/Camera/Enabled Subsystem'
 * '<S12>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem'
 * '<S13>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor'
 * '<S14>'  : 'robotarm_student_2021a_Ipos/RobotArm/Subsystem/Ipos'
 * '<S15>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant'
 * '<S16>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Compare To Constant1'
 * '<S17>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/HomingBusyCheck'
 * '<S18>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem'
 * '<S19>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R'
 * '<S20>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X'
 * '<S21>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z'
 * '<S22>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1'
 * '<S23>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring'
 * '<S24>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem'
 * '<S25>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3'
 * '<S26>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem'
 * '<S27>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Subsystem/LED Ring/Subsystem3/If Action Subsystem1'
 ...
 * '<S30>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Angle2Z'
 * '<S31>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory'
 * '<S32>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Selector1'
 * '<S33>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Supervisor'
 * '<S34>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller R/Point-to-point trajectory/Discrete Derivative'
 * '<S35>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X1'
 * '<S36>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Controller X2'
 * '<S37>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory'
 * '<S38>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector'
 * '<S39>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector1'
 * '<S40>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector2'
 * '<S41>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Selector3'
 * '<S42>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Supervisor2'
 * '<S43>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller X/Point-to-point trajectory/Discrete Derivative'
 * '<S44>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/    '
 * '<S45>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/     '
 * '<S46>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Angle2Z'
 * '<S47>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory'
 * '<S48>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector'
 * '<S49>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector1'
 * '<S50>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector2'
 * '<S51>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Selector3'
 * '<S52>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Supervisor'
 * '<S53>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Controller Z/Point-to-point trajectory/Discrete Derivative'
 * '<S54>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Controller Conveyor'
 * '<S55>'  : 'robotarm_student_2021a_Ipos/RobotArm/Supervisor/Supervisory Conveyor1/Supervisor'
 */
