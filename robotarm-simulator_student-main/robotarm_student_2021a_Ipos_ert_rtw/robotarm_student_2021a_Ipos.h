...
typedef struct {
  ...
  real_T jogSpeed_i;                   /* '<S22>/Supervisor' */
  real_T toPoint;                      /* '<S22>/Supervisor' */
  real_T homeControllerEnabled_b;      /* '<S22>/Supervisor' */
  real_T resetEnc_g;                   /* '<S22>/Supervisor' */
  real_T homingBusy_n;                 /* '<S22>/Supervisor' */
  real_T airBagEnabled;                /* '<S22>/Supervisor' */
  real_T airBagRef;                    /* '<S22>/Supervisor' */
  real_T controlEnabled;               /* '<S22>/Supervisor' */
  real_T Ready_n;                      /* '<S22>/Supervisor' */
  real_T StopSim_n;                    /* '<S22>/Supervisor' */
  real_T y;                            /* '<S22>/Angle2Z' */
  real_T jogSpeed_c;                   /* '<S21>/Supervisor2' */
  real_T toPoint_e;                    /* '<S21>/Supervisor2' */
  real_T homeControllerEnabled_k;      /* '<S21>/Supervisor2' */
  real_T resetEnc_c;                   /* '<S21>/Supervisor2' */
  real_T homingBusy_j;                 /* '<S21>/Supervisor2' */
  real_T airBagEnabled_o;              /* '<S21>/Supervisor2' */
  real_T airBagRef_a;                  /* '<S21>/Supervisor2' */
  real_T controlEnabled_a;             /* '<S21>/Supervisor2' */
  real_T Ready_i;                      /* '<S21>/Supervisor2' */
  real_T StopSim_o;                    /* '<S21>/Supervisor2' */
  real_T jogSpeed_o;                   /* '<S20>/Supervisor' */
  real_T toPoint_b;                    /* '<S20>/Supervisor' */
  real_T homeControllerEnabled_o;      /* '<S20>/Supervisor' */
  real_T resetEnc_k;                   /* '<S20>/Supervisor' */
  real_T freddy_k;                     /* '<S20>/Supervisor' */
  real_T homingBusy_l;                 /* '<S20>/Supervisor' */
  real_T airBagEnabled_f;              /* '<S20>/Supervisor' */
  real_T airBagRef_g;                  /* '<S20>/Supervisor' */
  real_T controlEnabled_l;             /* '<S20>/Supervisor' */
  real_T Ready_a;                      /* '<S20>/Supervisor' */
  real_T StopSim_j;                    /* '<S20>/Supervisor' */
  real_T y_b;                          /* '<S20>/Angle2Z' */
  ...
  real_T Gain1_oz;                     /* '<S10>/Gain1' */
  real_T Dctleadlag2;                  /* '<S10>/Dctleadlag2' */
  real_T Dctintegrator3_l;             /* '<S10>/Dctintegrator3' */
  real_T Dctnotch4;                    /* '<S10>/Dctnotch4' */
  real_T Dctpd5;                       /* '<S10>/Dctpd5' */
  ...
  real_T R_rad;                        /* '<S1>/Stateflow ' */
  real_T X_rad;                        /* '<S1>/Stateflow ' */
  real_T Z_rad;                        /* '<S1>/Stateflow ' */
  real_T In1;                          /* '<S12>/In1' */
  real_T d12;
  real_T fx1_tmp;
  real_T fy1_tmp;
...
typedef struct {
  ...
  real_T currentcarPos_d;              /* '<S21>/Supervisor2' */
  real_T currentcarPos_l;              /* '<S20>/Supervisor' */
  real_T treshold;                     /* '<S1>/Stateflow ' */
  ...
  real_T Dctleadlag2_RWORK[2];         /* '<S10>/Dctleadlag2' */
  real_T Dctintegrator3_RWORK_g[2];    /* '<S10>/Dctintegrator3' */
  real_T Dctnotch4_RWORK[4];           /* '<S10>/Dctnotch4' */
  real_T Dctpd5_RWORK[2];              /* '<S10>/Dctpd5' */
  ...
  real_T Dctintegrator3_RWORK_gc[2];   /* '<S5>/Dctintegrator3' */
  ...
  int32_T sfEvent_n;                   /* '<S22>/Supervisor' */
  int32_T sfEvent_h;                   /* '<S21>/Supervisor2' */
  int32_T sfEvent_k;                   /* '<S20>/Supervisor' */
  int32_T sfEvent_nm;                  /* '<S1>/Stateflow ' */
  ...
  uint32_T is_inreach;                 /* '<S1>/Stateflow ' */
  uint32_T is_Invkin;                  /* '<S1>/Stateflow ' */
  uint16_T temporalCounter_i1;         /* '<S23>/Supervisor' */
  uint16_T temporalCounter_i1_m;       /* '<S22>/Supervisor' */
  uint16_T temporalCounter_i1_me;      /* '<S21>/Supervisor2' */
  uint16_T temporalCounter_i1_c;       /* '<S20>/Supervisor' */
  uint16_T temporalCounter_i1_p;       /* '<S1>/Stateflow ' */
  uint16_T temporalCounter_i2;         /* '<S1>/Stateflow ' */
  ...
  uint8_T is_active_inreach;           /* '<S1>/Stateflow ' */
  uint8_T is_active_Invkin;            /* '<S1>/Stateflow ' */
...
struct P_robotarm_student_2021a_Ipos_T_ {
  ...
  /* Expression: [0                    0                    0      1737999991.6633;0  0  0  0;0  0  0  0]
  ...
  real_T Dctintegrator3_P1_Size[2];/* Computed Parameter: Dctintegrator3_P1_Size
                                    * Referenced by: '<S10>/Dctintegrator3'
                                    */
  ...
  real_T FeedfowardXV_Value;           /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain_e5;                /* Expression: 1
 ...
 * '<S10>'  : 'robotarm_student_2021a_Ipos/Controller/r_controller_without_double_integrator'
